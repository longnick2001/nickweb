...
const helpContent = {
	...
	shellSize: {
		...
		body: 'Pháo hoa càng lớn thì phạm vi nở càng rộng, nhưng pháo hoa càng lớn thì thiết bị càng yêu cầu hiệu suất cao hơn. Pháo hoa lớn có thể khiến thiết bị của bạn bị đóng băng.'
	},
	quality: {
	...
	autoLaunch: {
		...
		body: 'Sau khi bật lên, bạn có thể ngồi trước màn hình máy và thưởng thức pháo hoa, cũng có thể tắt đi nhưng sau khi tắt đi, bạn chỉ có thể bắn pháo hoa bằng cách chạm vào màn hình.'
	},
	finaleMode: {
		header: 'Bắn nhiều pháo hoa cùng lúc',
		body: 'Bạn có thể tự động bắn nhiều pháo hoa cùng lúc (nhưng trước tiên bạn cần bật "Pháo hoa tự động").'
	},
	hideControls: {
		header: 'Ẩn các nút điều khiển',
		body: 'Ẩn các nút ở đầu màn hình. Nếu muốn chụp ảnh màn hình hoặc cần trải nghiệm liền mạch thì bạn có thể ẩn nút đi, sau khi ẩn nút bạn vẫn có thể mở cài đặt ở góc trên bên phải.'
	},
	fullscreen: {
...
if (IS_HEADER) {
	...
	setLoadingStatus('Phát sáng lên nào');
	setTimeout(() => {
